...
public class SetMain {
    public static void main(String[] args) {
        ...
        String[] divineWords = {"to", "err", "is", "human", "art"};

        // no set or map literal so need to use Arrays.asList
        ...
        System.out.println("sym diff "+ unionTest.removeAll(intersectionTest));
        printSet(unionTest);

        // containsAll (is one set a superset of another? )
